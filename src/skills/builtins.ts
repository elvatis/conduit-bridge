...
/** Construct the six built-in executable tools without opening storage or authenticating providers. */
export function createSkillRegistry(): SkillRegistry {
  return new SkillRegistry([webSearchSkill, filesystemSkill, githubActionsSkill, browserSkill, memorySkill, sandboxSkill]);
}
