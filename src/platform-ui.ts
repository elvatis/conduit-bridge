          ...
          <div class="platform-panel">
            ...
            <details class="platform-context"><summary data-i18n="ui_model_context_retention">Model, context &amp; retention</summary>
              <div class="platform-fields">
                <label><span data-i18n="lbl_next_reply_model">Model for the next reply</span><select id="pf-chat-model"></select></label>
...
export const PLATFORM_SCRIPT = String.raw`
  ...
  function platformSyncModels() {
    ...
    for (const id of ['pf-chat-model', 'pf-entry-model', 'pf-run-model', 'pf-preset-model']) pfOptions(id, available, available.length ? undefined : () => t('ui_no_models_available'), item => item.id, item => item.id);
