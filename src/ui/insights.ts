...
export const INSIGHTS_HTML = `<section id="insights-section" class="wide page-section" aria-labelledby="ins-heading">
  ...
  <p class="ins-note muted" data-i18n="ins_note">Information questions, tentative suggestions and test echoes are omitted. Ambiguous statements may also be left out. Check the linked original messages for context. Nothing is executed or added to memory automatically.</p>
</section>`;
...
export const INSIGHTS_COPY = {
  en: {
    ins_nav:'Insights', ins_heading:'What your conversations reveal', ins_intro:'Original statements from your saved conversations, selected with local BitNet.', ins_refresh:'Build insights', ins_update:'Refresh insights', ins_resume:'Continue analysis', ins_cancel:'Cancel analysis', ins_progress:'Analysis progress', ins_local:'Local BitNet',
    ...
    ins_empty_title:'Keep the useful parts.', ins_empty:'Start an analysis to gather insights across your own saved chats. Long conversations are processed in small sections.', ins_example_link:'How it works, with an example', ins_note:'Information questions, tentative suggestions and test echoes are omitted. Ambiguous statements may also be left out. Check the linked original messages for context. Nothing is executed or added to memory automatically.',
  ...
  de: {
    ins_nav:'Erkenntnisse', ins_heading:'Was aus Ihren Gesprächen bleibt', ins_intro:'Originalaussagen aus gespeicherten Gesprächen, mit lokalem BitNet ausgewählt.', ins_refresh:'Erkenntnisse bündeln', ins_update:'Erkenntnisse aktualisieren', ins_resume:'Auswertung fortsetzen', ins_cancel:'Auswertung abbrechen', ins_progress:'Fortschritt der Auswertung', ins_local:'Lokales BitNet',
    ...
    ins_empty_title:'Das Nützliche festhalten.', ins_empty:'Bündeln Sie Erkenntnisse aus Ihren eigenen gespeicherten Chats. Lange Gespräche werden in kleinen Abschnitten verarbeitet.', ins_example_link:'So funktioniert es, mit Beispiel', ins_note:'Wissensfragen, unverbindliche Vorschläge und reine Testausgaben werden ausgespart. Auch mehrdeutige Aussagen können entfallen. Die verknüpften Originalnachrichten liefern den Kontext. Aufgaben werden nicht automatisch ausgeführt oder als Erinnerung übernommen.',
