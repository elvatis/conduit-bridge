...
export const WORKSPACE_STYLE = String.raw`
  ...
  .brand h1 { font:inherit; font-weight:600; font-size:15px; letter-spacing:-.3px; margin:0; }
  ...
  .sidebar-history h3 { font-size:11px; font-weight:500; margin:0 10px 9px; color:var(--muted); }
  ...
  .sidebar-history input { border:0; background:transparent; padding:7px 10px; font-size:12px; }
  ...
  .sidebar-history .platform-list strong { display:block; font-size:12px; font-weight:400; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
  .sidebar-history .platform-list small { display:none; }
  .sidebar-history .platform-empty { font-size:12px; text-align:left; padding:8px 10px; }
  ...
  .nav-advanced > summary { display:flex; align-items:center; gap:11px; padding:9px 11px; cursor:pointer; color:var(--muted); border-radius:8px; list-style:none; font-size:13px; }
  ...
  .nav-group-label { font:inherit; font-size:10px; letter-spacing:0; text-transform:none; opacity:1; padding-top:14px; }
  .nav-custom-trigger { border:0; font-size:11px; margin:4px 0; }
  .side-footer { border:0; font-size:10px; padding:8px 10px 0; margin:0; }
  ...
  .appbrand { font:inherit; font-size:13px; letter-spacing:0; color:var(--muted); }
  ...
  .chat-suggestions button { background:transparent; border:1px solid var(--line-2); border-radius:999px; font-size:12px; padding:7px 13px; color:var(--body); }
  ...
  .platform-message header small { font-size:10px; opacity:.6; }
  ...
  .composer-model select { width:100%; border:0; background:transparent; padding:6px 4px; color:var(--muted); font-size:12px; }
  ...
  #pf-chat-progress { flex:1 0 100%; font-size:11px; }
  #pf-chat-progress:empty { display:none; }
  .chat-footnote { text-align:center; font-size:11px; color:var(--muted); margin:11px 0 0; }
